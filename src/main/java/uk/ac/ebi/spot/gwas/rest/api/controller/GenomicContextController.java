...
public class GenomicContextController {
    ...
    public GenomicContextDTO getGenomicContext(@PathVariable String rsId ,@PathVariable String genomicContextId) {
        GenomicContext genomicContext = genomicContextService.findByGenomicContextId(genomicContextId);
